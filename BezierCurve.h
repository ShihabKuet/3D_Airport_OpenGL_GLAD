...
public:
    ...
    ~BezierCurve() {}
    void drawBezierCurveWithTexture(Shader& lightingShader, glm::mat4 model, glm::vec3 amb)
    {
        lightingShader.use();
...
private:
    ...
    unsigned int hollowBezier(GLfloat ctrlpoints[], int L)
    {
        ...
        glEnableVertexAttribArray(2); // updated
        ...
        glVertexAttribPointer(2, 2, GL_FLOAT, false, 24, (void*)(sizeof(float) * 6)); // updated
