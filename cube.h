...
public:
    ...
    void drawCubeTransparent(Shader& lightingShader, glm::mat4 model = glm::mat4(1.0f), float r = 1.0f, float g = 1.0f, float b = 1.0f, float alpha = 0.3f)
    {
        lightingShader.use();
    ...
    void drawCubeTransparentWithTexture(Shader& transparentShader, unsigned int& transparentVAO, unsigned int& transparentTexture, glm::mat4 modelMatrix)
    {
        // Transparent Window
        ...
        transparentShader.setMat4("model", modelMatrix);
